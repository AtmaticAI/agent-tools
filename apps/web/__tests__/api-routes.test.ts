...
import type { ToolCategory, ToolSettings, SettingsRepository } from '@atmaticai/agent-tools/settings';
import { SettingsService, ALL_TOOL_CATEGORIES, DEFAULT_SETTINGS } from '@atmaticai/agent-tools/settings';
...
describe('guardTool', () => {
  ...
  // imports settingsService from '@atmaticai/agent-tools/settings' and calls
  ...
  it('should return null (allowed) when tool is enabled', async () => {
    vi.doMock('@atmaticai/agent-tools/settings', () => ({
      settingsService: {
